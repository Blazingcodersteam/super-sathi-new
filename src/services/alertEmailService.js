...
exports.processAlertEmailJob = processAlertEmailJob;
...
async function processAlertEmailJob(data) {
    var _a, _b;
    const startedAt = performance.now();
    const meta = data.meta || {};
    const logMeta = `event=${meta.event || "unknown"} receiver=${data.userId || "external"} sender=${(_a = meta.senderUserId) !== null && _a !== void 0 ? _a : "n/a"} request=${meta.requestId || "n/a"}`;
    ...
    if (!targetEmail && data.userId) {
       ...
       JOIN user_profiles up ON u.id = up.user_id WHERE u.id = ?`, [data.userId]);
        targetEmail = userRow === null || userRow === void 0 ? void 0 : userRow.email;
        recipientName = (_b = userRow === null || userRow === void 0 ? void 0 : userRow.first_name) !== null && _b !== void 0 ? _b : "User";
    }
    if (!targetEmail) {
    ...
    const variables = Object.assign({ user_name: recipientName }, data.variables);
    const result = await EmailService_1.EmailService.sendTemplateEmail(data.templateKey, targetEmail, variables, {
...
//# sourceMappingURL=alertEmailService.js.map