...
exports.getPaymentInvoice = getPaymentInvoice;
...
async function getPaymentInvoice(req, res) {
    ...
    `, [paymentId, paymentId, paymentId, userId]);
        ...
        if (!pdfUrl && payment.payment_status === 'paid') {
            try {
                const paymentData = Object.assign(Object.assign({}, payment), { invoice_number: invoiceNumber, base_amount: baseAmount, total_gst_amount: totalGstAmount });
        ...
        const invoice = {
            ...
            gst_breakdown: Object.assign(Object.assign({ type: gstType || 'IGST' }, (gstType === 'CGST_SGST' ? {
            ...
            payment_method: ((_a = payment.payment_method) === null || _a === void 0 ? void 0 : _a.toUpperCase()) || 'UPI',
...
async function verifyPayment(req, res) {
    ...
    `, [razorpay_order_id, userId]);
      ...
      `, [razorpay_order_id]);
        ...
        VALUES (?, ?, ?, ?, ?, 'failed', ?, ?)
      `, [userId, razorpay_order_id, razorpay_payment_id, razorpay_signature, paymentOrder.amount, ((_a = razorpayError.error) === null || _a === void 0 ? void 0 : _a.code) || 'UNKNOWN', razorpayError.message]);
            await query(`
        UPDATE payment_orders SET status = 'failed' WHERE order_id = ?
      `, [razorpay_order_id]);
    ...
    `, [userId]);
        ...
        const formattedPendingOrders = pendingOrders.map(order => {
            ...
            return ({
                ...
                payment_method: ((_a = order.payment_gateway) === null || _a === void 0 ? void 0 : _a.toUpperCase()) || 'RAZORPAY',
