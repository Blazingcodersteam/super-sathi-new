...
export async function getGSTConfig(req, res) {
  try {
...
export async function updateGSTConfig(req, res) {
  try {
...
export async function getStateGSTMapping(req, res) {
  try {
...
export async function updateStateGSTMapping(req, res) {
  try {
    ...
    for (const mapping of gst_mappings) {
      ...
      if (!gst_type_id || percentage === undefined) continue;
...
export async function bulkUpdateStateGSTMapping(req, res) {
  try {
    ...
    for (const stateMapping of bulk_mappings) {
      ...
      if (!state_id || !gst_mappings || !Array.isArray(gst_mappings)) continue;
