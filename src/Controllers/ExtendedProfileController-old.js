...
exports.updateAstro = updateAstro;
exports.updateFamily = updateFamily;
exports.updateCareer = updateCareer;
exports.updateLocation = updateLocation;
exports.updateHobbies = updateHobbies;
const utils = require("util");
const db = require("../database");
const query = utils.promisify(db.query).bind(db);
// Get Complete User Profile
async function getCompleteProfile(req, res) {
    try {
        ...
        const [profile] = await query(`SELECT u.vivaaha_user_id, u.email, u.phone, u.email_verified, u.phone_verified,
       ...
       WHERE ld.user_id = ?`, [userId]);
        ...
        if (location && location.grew_up_in_ids) {
            try {
                const ids = JSON.parse(location.grew_up_in_ids);
                location.grew_up_in_ids = ids;
                if (ids.length > 0) {
                    const uniqueIds = [...new Set(ids)];
                    const countryRows = await query(`SELECT id, country_name FROM country_code_master WHERE id IN (${uniqueIds.map(() => '?').join(',')})`, uniqueIds);
                    const countryMap = {};
                    for (const row of countryRows)
                        countryMap[row.id] = row.country_name;
       ...
       WHERE ed.user_id = ?`, [userId]);
        ...
        // Get audio files
        const audioFiles = await query(`SELECT * FROM user_audio_files WHERE user_id = ? ORDER BY created_at DESC`, [userId]);
    ...
    `, [userId]);
       ...
       WHERE ugiv.user_id = ?`, [userId]);
        ...
        const [aadhaarVerification] = await query(`SELECT verification_status, verified_at, verified_name
       ...
       ORDER BY us.created_at DESC LIMIT 1`, [userId]);
        ...
        console.log("   ── BASIC ──");
        console.log("   first_name:", (profile === null || profile === void 0 ? void 0 : profile.first_name) || "❌ NULL");
        console.log("   last_name:", (profile === null || profile === void 0 ? void 0 : profile.last_name) || "❌ NULL");
        console.log("   date_of_birth:", (profile === null || profile === void 0 ? void 0 : profile.date_of_birth) || "❌ NULL");
        console.log("   age:", (profile === null || profile === void 0 ? void 0 : profile.age) || "❌ NULL");
        console.log("   height:", (profile === null || profile === void 0 ? void 0 : profile.height) || "❌ NULL");
        console.log("   gender_id:", (profile === null || profile === void 0 ? void 0 : profile.gender_id) || "❌ NULL");
        console.log("   religion_id:", (profile === null || profile === void 0 ? void 0 : profile.religion_id) || "❌ NULL", "→", (profile === null || profile === void 0 ? void 0 : profile.religion_name) || "");
        console.log("   community_id:", (profile === null || profile === void 0 ? void 0 : profile.community_id) || "❌ NULL", "→", (profile === null || profile === void 0 ? void 0 : profile.community_name) || "");
        console.log("   caste_id:", (profile === null || profile === void 0 ? void 0 : profile.caste_id) || "❌ NULL", "→", (profile === null || profile === void 0 ? void 0 : profile.caste_name) || "");
        console.log("   mother_tongue_id:", (profile === null || profile === void 0 ? void 0 : profile.mother_tongue_id) || "❌ NULL", "→", (profile === null || profile === void 0 ? void 0 : profile.mother_tongue) || "");
        console.log("   marital_status_id:", (profile === null || profile === void 0 ? void 0 : profile.marital_status_id) || "❌ NULL", "→", (profile === null || profile === void 0 ? void 0 : profile.marital_status) || "");
        console.log("   diet_id:", (profile === null || profile === void 0 ? void 0 : profile.diet_id) || "❌ NULL");
        console.log("   about_myself:", (profile === null || profile === void 0 ? void 0 : profile.about_myself) ? "✅ (" + profile.about_myself.length + " chars)" : "❌ NULL");
        console.log("   ── CAREER ──");
        console.log("   occupation:", (career === null || career === void 0 ? void 0 : career.occupation) || "❌ NULL");
        console.log("   company_name:", (career === null || career === void 0 ? void 0 : career.company_name) || "❌ NULL");
        console.log("   annual_income:", (career === null || career === void 0 ? void 0 : career.annual_income) || "❌ NULL");
        console.log("   income_type:", (career === null || career === void 0 ? void 0 : career.income_type) || "❌ NULL");
        console.log("   grew_up_in_ids:", (career === null || career === void 0 ? void 0 : career.grew_up_in_ids) || "❌ NULL");
        console.log("   ethnic_origin_id:", (career === null || career === void 0 ? void 0 : career.ethnic_origin_id) || "❌ NULL");
        console.log("   country_living_in_id:", (career === null || career === void 0 ? void 0 : career.country_living_in_id) || "❌ NULL");
        console.log("   city_living_in:", (career === null || career === void 0 ? void 0 : career.city_living_in) || "❌ NULL");
        console.log("   ── LOCATION ──");
        console.log("   city_id:", (location === null || location === void 0 ? void 0 : location.city_id) || "❌ NULL", "→", (location === null || location === void 0 ? void 0 : location.city_name) || "");
        console.log("   state_id:", (location === null || location === void 0 ? void 0 : location.state_id) || "❌ NULL", "→", (location === null || location === void 0 ? void 0 : location.state_name) || "");
        console.log("   country_id:", (location === null || location === void 0 ? void 0 : location.country_id) || "❌ NULL", "→", (location === null || location === void 0 ? void 0 : location.country_name) || "");
        console.log("   ── EDUCATION ──");
        console.log("   education_level_id:", (education === null || education === void 0 ? void 0 : education.education_level_id) || "❌ NULL", "→", (education === null || education === void 0 ? void 0 : education.level_name) || "");
        console.log("   institution_name:", (education === null || education === void 0 ? void 0 : education.institution_name) || "❌ NULL");
        console.log("   ── FAMILY ──");
        console.log("   family:", family ? "✅ exists" : "❌ NULL (not created)");
        console.log("   ── ASTRO ──");
        console.log("   astro:", astro ? "✅ exists" : "❌ NULL (not created)");
        console.log("   ── PHOTOS ──");
        console.log("   photos count:", (photos === null || photos === void 0 ? void 0 : photos.length) || 0);
        console.log("   ── HOBBIES ──");
...
async function updateBasic(req, res) {
    try {
        ...
        if (req.body.email) {
            ...
            const [existingUser] = await query(`SELECT id
        FROM users
        WHERE email = ?
          AND id != ?
        LIMIT 1`, [req.body.email, userId]);
            if (existingUser) {
        ...
        SET email = ?
        WHERE id = ?`, [req.body.email, userId]);
        }
        const updates = [];
        const values = [];
        if (first_name) {
...
async function updateAstro(req, res) {
    try {
        const userId = req.user.user_id;
...
async function updateFamily(req, res) {
    try {
        ...
        if (existing) {
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [userId, father_name, father_occupation_id, mother_name, mother_occupation_id, no_of_sisters,
                no_of_brothers, family_country_id, family_state, family_financial_status_id,
...
async function updateCareer(req, res) {
    try {
        ...
        if (existing) {
         ...
         keep_income_private = ? WHERE user_id = ?`, [highest_qualification || null, college_attended || null, working_with_id || null, working_as || null, employer_name || null,
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 1)`, [userId, highest_qualification || null, college_attended || null, working_with_id || null, working_as || null,
        ...
        if (college_attended || college_attended_2) {
            ...
            if (eduExists) {
                await query(`UPDATE education_details SET institution_name = ?, institution_name_2 = ? WHERE user_id = ?`, [college_attended, college_attended_2, userId]);
            }
            else {
                await query(`INSERT INTO education_details (user_id, institution_name, institution_name_2, education_level_id) VALUES (?, ?, ?, 1)`, [userId, college_attended, college_attended_2]);
            }
        }
...
async function updateLocation(req, res) {
    try {
        ...
        if (existing) {
         ...
         state_living_in = ?, state_id = ?, city_id = ?, country_id = ?, zip_code = ?, latitude = ?, longitude = ? WHERE user_id = ?`, [current_residence || null, residency_status || null, state_living_in || null, state_id || null, city_id || null, country_id || null, zip_code || null, latitude || null, longitude || null, userId]);
        }
        else {
            await query(`INSERT INTO location_details (user_id, current_residence, residency_status,
         state_living_in, state_id, city_id, country_id, zip_code, latitude, longitude) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [userId, current_residence || null, residency_status || null, state_living_in || null, state_id || null, city_id || null, country_id || null, zip_code || null, latitude || null, longitude || null]);
        }
        ...
        if (grew_up_in !== undefined || ethnic_origin_id !== undefined) {
            ...
            if (careerExists) {
                ...
                await query(`INSERT INTO career_details (user_id, grew_up_in_ids, ethnic_origin_id, currency_id) VALUES (?, ?, ?, 1)`, [userId, JSON.stringify(grew_up_in || []), ethnic_origin_id || null]);
            }
        }
...
// Update Hobbies
async function updateHobbies(req, res) {
    try {
        const userId = req.user.user_id;
...
//# sourceMappingURL=ExtendedProfileController-old.js.map