...
exports.getAllStatesWithGST = getAllStatesWithGST;
exports.getStateGSTConfig = getStateGSTConfig;
exports.createOrUpdateStateGST = createOrUpdateStateGST;
exports.bulkCreateOrUpdateStatesGST = bulkCreateOrUpdateStatesGST;
exports.deleteStateGSTConfig = deleteStateGSTConfig;
exports.debugStateGSTMappings = debugStateGSTMappings;
const utils = require("util");
const db = require("../database");
const query = utils.promisify(db.query).bind(db);
// Get all states with their GST configurations
async function getAllStatesWithGST(req, res) {
    try {
    ...
    `, [...searchParams, parseInt(limit), offset]);
      ...
      `, stateIds);
        ...
        const statesWithGST = states.map(state => (Object.assign(Object.assign({}, state), { gst_mappings: gstMappings.filter(mapping => mapping.state_id === state.state_id) })));
...
async function getStateGSTConfig(req, res) {
    try {
...
async function createOrUpdateStateGST(req, res) {
    var _a, _b;
    try {
        const { state_id } = req.params;
    ...
    `, [state_id]);
      ...
      `, [state_id, gst_type_id]);
          ...
          WHERE state_id = ? AND gst_type_id = ?
        `, [percentage, ((_a = req.admin) === null || _a === void 0 ? void 0 : _a.id) || null, state_id, gst_type_id]);
                updatedCount++;
            }
            else {
                // Create new mapping
          ...
          VALUES (?, ?, ?, 1, ?)
        `, [state_id, gst_type_id, percentage, ((_b = req.admin) === null || _b === void 0 ? void 0 : _b.id) || null]);
                createdCount++;
            }
        }
        res.json({
...
async function bulkCreateOrUpdateStatesGST(req, res) {
    var _a, _b;
    try {
...
async function deleteStateGSTConfig(req, res) {
    var _a, _b;
    try {
        const { state_id } = req.params;
      ...
      `, [((_a = req.admin) === null || _a === void 0 ? void 0 : _a.id) || null, state_id, gst_type_id]);
      ...
      `, [((_b = req.admin) === null || _b === void 0 ? void 0 : _b.id) || null, state_id]);
            res.json({
                success: true,
...
async function debugStateGSTMappings(req, res) {
    try {
        const { state_id } = req.params;
...
//# sourceMappingURL=StateGSTController.js.map