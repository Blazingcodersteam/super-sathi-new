...
exports.sendAdminReply = sendAdminReply;
...
async function submitContactForm(req, res) {
    ...
    `, [full_name, email, phone || null, subject, message]);
        ...
        const adminEmail = (settings === null || settings === void 0 ? void 0 : settings.email_1) || (settings === null || settings === void 0 ? void 0 : settings.email_2);
        const variables = {
            user_name: full_name,
            email,
...
async function sendAdminReply(req, res) {
    ...
    `, [contact_id]);
        ...
        // Send reply email
        await EmailService_1.EmailService.sendTemplateEmail('contact_reply', contact.email, { user_name: contact.full_name, subject: contact.subject, reply_message: reply_message.replace(/\n/g, '<br>') }, {
        ...
        const adminId = ((_a = req.admin) === null || _a === void 0 ? void 0 : _a.user_id) || null;
