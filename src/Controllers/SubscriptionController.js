...
exports.getSubscriptionAddons = getSubscriptionAddons;
exports.checkSubscriptionStatus = checkSubscriptionStatus;
exports.requestRefund = requestRefund;
exports.getMyRefundRequests = getMyRefundRequests;
...
async function getUserSubscription(req, res) {
    ...
    `, [userId]);
      ...
      `, [subscription.payment_id]);
            subscriptionData = Object.assign(Object.assign({}, subscription), { features,
                addons, is_active: subscription.subscription_status === 'active' });
        }
...
async function getSubscriptionFeatures(req, res) {
    try {
        const features = await query(`
...
async function getSubscriptionAddons(req, res) {
    try {
        const addons = await query(`
      SELECT sam.*, cm.currency_code, cm.symbol
      FROM subscription_addons_master sam
...
async function checkSubscriptionStatus(req, res) {
    ...
    `, [userId]);
        ...
        const restrictionsEnabled = await (0, subscriptionAccess_1.areSubscriptionRestrictionsEnabled)();
