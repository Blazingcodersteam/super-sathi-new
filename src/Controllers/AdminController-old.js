...
async function getAllUsers(req, res) {
    try {
       ...
       ORDER BY u.created_at DESC`;
        ...
        const processedUsers = users.map(user => (Object.assign(Object.assign({}, user), { subscription_plan: user.subscription_plan ?
...
async function updateGeneralSettings(req, res) {
    try {
        const { site_name, site_logo, primary_color, secondary_color, email_1, email_2, phone_number, address, facebook_url, instagram_url, twitter_url, linkedin_url, youtube_url, threads_url, smtp_host, smtp_port, smtp_username, smtp_password, smtp_encryption, smtp_from_email, smtp_from_name, subscription_restrictions } = req.body;
...
async function uploadSiteLogoFile(req, res) {
    try {
        ...
        if (existing) {
            ...
            await query('INSERT INTO general_settings (site_logo, site_name, primary_color, secondary_color, smtp_encryption, smtp_from_name) VALUES (?, ?, ?, ?, ?, ?)', [logoUrl, 'Vivaaha', '#000000', '#000000', 'tls', 'Vivaaha']);
        }
        res.json({
            success: true,
...
//# sourceMappingURL=AdminController-old.js.map