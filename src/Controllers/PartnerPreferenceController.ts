...
export async function getPartnerPreferences(req, res) {
  try {
    ...
    const parsedPreferences = {
      ...preferences,
      marital_status_ids: preferences.marital_status_ids ? JSON.parse(preferences.marital_status_ids) : [],
      religion_ids: preferences.religion_ids ? JSON.parse(preferences.religion_ids) : [],
      community_ids: preferences.community_ids ? JSON.parse(preferences.community_ids) : [],
      mother_tongue_ids: preferences.mother_tongue_ids ? JSON.parse(preferences.mother_tongue_ids) : [],
      education_level_ids: preferences.education_level_ids ? JSON.parse(preferences.education_level_ids) : [],
      working_with_ids: preferences.working_with_ids ? JSON.parse(preferences.working_with_ids) : [],
      profession_ids: preferences.profession_ids ? JSON.parse(preferences.profession_ids) : [],
      country_ids: preferences.country_ids ? JSON.parse(preferences.country_ids) : [],
      state_ids: preferences.state_ids ? JSON.parse(preferences.state_ids) : [],
      profile_managed_by_ids: preferences.profile_managed_by_ids ? JSON.parse(preferences.profile_managed_by_ids) : [],
      diet_ids: preferences.diet_ids ? JSON.parse(preferences.diet_ids) : []
    };
...
export async function upsertPartnerPreferences(req, res) {
  try {
    const userId = req.user.user_id;
    const {
    ...
    const parsedUpdatedPrefs = {
      ...updatedPrefs,
      marital_status_ids: updatedPrefs.marital_status_ids ? JSON.parse(updatedPrefs.marital_status_ids) : [],
      religion_ids: updatedPrefs.religion_ids ? JSON.parse(updatedPrefs.religion_ids) : [],
      community_ids: updatedPrefs.community_ids ? JSON.parse(updatedPrefs.community_ids) : [],
      mother_tongue_ids: updatedPrefs.mother_tongue_ids ? JSON.parse(updatedPrefs.mother_tongue_ids) : [],
      education_level_ids: updatedPrefs.education_level_ids ? JSON.parse(updatedPrefs.education_level_ids) : [],
      working_with_ids: updatedPrefs.working_with_ids ? JSON.parse(updatedPrefs.working_with_ids) : [],
      profession_ids: updatedPrefs.profession_ids ? JSON.parse(updatedPrefs.profession_ids) : [],
      country_ids: updatedPrefs.country_ids ? JSON.parse(updatedPrefs.country_ids) : [],
      state_ids: updatedPrefs.state_ids ? JSON.parse(updatedPrefs.state_ids) : [],
      profile_managed_by_ids: updatedPrefs.profile_managed_by_ids ? JSON.parse(updatedPrefs.profile_managed_by_ids) : [],
      diet_ids: updatedPrefs.diet_ids ? JSON.parse(updatedPrefs.diet_ids) : []
    };
