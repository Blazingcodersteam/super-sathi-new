    ...
    try {
        ...
        if (existing) {
         ...
         WHERE id = ?`, [
            ...
            // Insert new settings
            await query(`INSERT INTO general_settings
         (site_name, site_logo, primary_color, secondary_color,
          email_1, email_2, phone_number, address,
          facebook_url, instagram_url, twitter_url, linkedin_url,
          youtube_url, threads_url, smtp_host, smtp_port,
...
async function uploadSiteLogoFile(req, res) {
    try {
        ...
        if (existing) {
            ...
            await query('INSERT INTO general_settings (site_logo, site_name, primary_color, secondary_color, smtp_encryption, smtp_from_name, subscription_restrictions, audio_restrictions, video_restrictions) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)', [logoUrl, 'Super sathi', '#000000', '#000000', 'tls', 'Super sathi', 0, 0, 0]);
        }
        res.json({
            success: true,
