...
exports.subscriptionAddonsMasterCRUD = exports.subscriptionFeaturesMasterCRUD = exports.subscriptionPlanFeaturesCRUD = exports.subscriptionPlansCRUD = void 0;
exports.adminLogin = adminLogin;
exports.getAllUsers = getAllUsers;
exports.getUserReports = getUserReports;
exports.getAllUsersFullReport = getAllUsersFullReport;
...
exports.updateWebsiteContent = updateWebsiteContent;
exports.updateContentField = updateContentField;
exports.updateHomepageBanner = updateHomepageBanner;
exports.uploadCEOImageFile = uploadCEOImageFile;
exports.getContentField = getContentField;
exports.getAllSuccessStories = getAllSuccessStories;
exports.getSuccessStoryById = getSuccessStoryById;
exports.approveSuccessStory = approveSuccessStory;
exports.rejectSuccessStory = rejectSuccessStory;
...
exports.uploadSuccessStoryPhoto = uploadSuccessStoryPhoto;
exports.deleteSuccessStoryPhoto = deleteSuccessStoryPhoto;
exports.updateSuccessStoryWithPhoto = updateSuccessStoryWithPhoto;
exports.updateUserProfile = updateUserProfile;
exports.updateUserReligiousInfo = updateUserReligiousInfo;
exports.updateUserGovernmentId = updateUserGovernmentId;
exports.updateUserBasic = updateUserBasic;
exports.updateUserAbout = updateUserAbout;
exports.updateUserAstro = updateUserAstro;
exports.updateUserFamily = updateUserFamily;
exports.updateUserCareer = updateUserCareer;
exports.updateUserLocation = updateUserLocation;
exports.updateCompleteUserProfile = updateCompleteUserProfile;
exports.createCompleteUserProfile = createCompleteUserProfile;
exports.updateUserHobbies = updateUserHobbies;
exports.adminUploadUserPhoto = adminUploadUserPhoto;
exports.adminUploadMultipleUserPhotos = adminUploadMultipleUserPhotos;
exports.adminGetUserPhotos = adminGetUserPhotos;
exports.adminDeleteUserPhoto = adminDeleteUserPhoto;
exports.adminSetUserPrimaryPhoto = adminSetUserPrimaryPhoto;
exports.getAllRefundRequests = getAllRefundRequests;
exports.getRefundRequestById = getRefundRequestById;
exports.approveRefundRequest = approveRefundRequest;
exports.rejectRefundRequest = rejectRefundRequest;
exports.updateRefundRequestStatus = updateRefundRequestStatus;
exports.getRefundStatistics = getRefundStatistics;
exports.getGeneralSettings = getGeneralSettings;
exports.updateGeneralSettings = updateGeneralSettings;
exports.uploadSiteLogoFile = uploadSiteLogoFile;
exports.getAdminProfile = getAdminProfile;
exports.updateAdminProfile = updateAdminProfile;
exports.changeAdminPassword = changeAdminPassword;
exports.getAllPaymentsHistory = getAllPaymentsHistory;
exports.getPaymentById = getPaymentById;
exports.getUserPaymentsHistory = getUserPaymentsHistory;
exports.getPaymentStatistics = getPaymentStatistics;
exports.updatePaymentStatus = updatePaymentStatus;
exports.createSiteSetting = createSiteSetting;
exports.getAllSiteSettings = getAllSiteSettings;
exports.getSiteSettingById = getSiteSettingById;
exports.getSiteSettingByName = getSiteSettingByName;
exports.updateSiteSetting = updateSiteSetting;
exports.deleteSiteSetting = deleteSiteSetting;
exports.createCurrencySetting = createCurrencySetting;
exports.getAllCurrencySettings = getAllCurrencySettings;
exports.getCurrencySettingById = getCurrencySettingById;
exports.updateCurrencySetting = updateCurrencySetting;
exports.deleteCurrencySetting = deleteCurrencySetting;
exports.getCurrencyFormats = getCurrencyFormats;
exports.getSymbolFormats = getSymbolFormats;
exports.getNoOfDecimals = getNoOfDecimals;
exports.createCurrencyFormat = createCurrencyFormat;
exports.updateCurrencyFormat = updateCurrencyFormat;
exports.deleteCurrencyFormat = deleteCurrencyFormat;
exports.createSymbolFormat = createSymbolFormat;
exports.updateSymbolFormat = updateSymbolFormat;
exports.deleteSymbolFormat = deleteSymbolFormat;
exports.createNoOfDecimals = createNoOfDecimals;
exports.updateNoOfDecimals = updateNoOfDecimals;
exports.deleteNoOfDecimals = deleteNoOfDecimals;
...
// Fake profile detection — score based (threshold: 3)
function getFakeScore(user) {
    let score = 0;
    const name = (user.first_name || '').toLowerCase().trim();
    // 3+ same consecutive chars anywhere: aaa, bbb, cccc
    if (/(.)\1{2,}/.test(name))
        score += 3;
    // Alternating 2-char pattern 3+ times: qwqwqw, asasas, ababab
    if (/^(..)\1{2,}$/.test(name))
        score += 3;
    ...
    if (normalizedPhone.length >= 8 && /^(.)\1+$/.test(normalizedPhone))
        score += 3;
    // Sequential digits: 1234567890, 9876543210
    if (/^(0123456789|9876543210|1234567890)$/.test(normalizedPhone))
        score += 3;
    // Invalid length
    if (normalizedPhone.length > 0 && (normalizedPhone.length < 7 || normalizedPhone.length > 12))
        score += 2;
    return score;
}
function isFakeProfile(user) {
    return getFakeScore(user) >= 3;
}
...
async function sendWelcomeEmail(email, firstName, password, vivaaha_user_id) {
    const subject = "Welcome to Vivaaha Matrimony - Your Account Details";
    const htmlBody = `
    <!DOCTYPE html>
    <html>
    <head>
...
async function adminLogin(req, res) {
    try {
        ...
        const [admin] = await query("SELECT * FROM users WHERE email = ? AND user_type_id = 2", [email]);
        if (!admin) {
        ...
        const token = jwt.sign({ user_id: admin.id, email: admin.email, user_type: "admin" }, JWT_SECRET, { expiresIn: "24h" });
        res.json({
            success: true,
...
async function getAllUsers(req, res) {
    try {
        const { page = 1, limit, search = "", vivahaid = "", gender, subscription_plan, fromdate, todate, status } = req.query;
        ...
        if (status !== undefined && status !== '') {
            ...
            whereClause += " AND u.status IN (1, 2, 3)"; // active + inactive + suspended (exclude deleted=4)
        }
        ...
        let queryStr = `SELECT DISTINCT u.id, u.email, u.phone, u.user_type_id, u.status, u.email_verified, u.phone_verified, u.created_at,
              ...
              (
                SELECT ld.city_id FROM location_details ld WHERE ld.user_id = u.id LIMIT 1
              ) as city_id,
              (
                SELECT ld.state_id FROM location_details ld WHERE ld.user_id = u.id LIMIT 1
              ) as state_id,
              (
       ...
       ORDER BY u.created_at DESC`;
        ...
        const parsedUsers = users.map(user => (Object.assign(Object.assign({}, user), { subscription_plan: user.subscription_plan ?
                (typeof user.subscription_plan === 'string' ?
                    JSON.parse(user.subscription_plan) :
                    user.subscription_plan) :
                null })));
        // Add is_fake_profile flag to each user
        const processedUsers = parsedUsers.map(user => (Object.assign(Object.assign({}, user), { is_fake_profile: isFakeProfile(user) })));
        // Separate users into verified, unverified, and deactivated arrays
        const aadhaar_verified = processedUsers.filter(user => user.aadhaar_verified === 1 && user.status === 1);
        const aadhaar_unverified = processedUsers.filter(user => (user.aadhaar_verified === 0 || user.aadhaar_verified === null) && user.status === 1);
        const deactivated_users = processedUsers.filter(user => user.status === 2);
        const suspended_users = processedUsers.filter(user => user.status === 3);
        const [{ total }] = await query(`SELECT COUNT(DISTINCT u.id) as total FROM users u
       LEFT JOIN user_profiles up ON u.id = up.user_id
       LEFT JOIN gender_master gm ON up.gender_id = gm.id
       ${whereClause}`, params);
        const fake_profiles = processedUsers.filter(user => user.is_fake_profile);
        const response = {
            success: true,
...
async function getUserReports(req, res) {
    try {
        ...
        const { search = "", status, report_type, fromdate, todate } = req.query;
        ...
        if (search) {
            whereClause += ` AND (
        reporter.email LIKE ? OR reporter.phone LIKE ? OR reporter.vivaaha_user_id LIKE ?
        OR reporterProfile.first_name LIKE ? OR reporterProfile.middle_name LIKE ? OR reporterProfile.last_name LIKE ?
        OR reported.email LIKE ? OR reported.phone LIKE ? OR reported.vivaaha_user_id LIKE ?
        OR reportedProfile.first_name LIKE ? OR reportedProfile.middle_name LIKE ? OR reportedProfile.last_name LIKE ?
        OR ur.description LIKE ?
      )`;
            const searchParam = `%${search}%`;
            params.push(searchParam, searchParam, searchParam, searchParam, searchParam, searchParam, searchParam, searchParam, searchParam, searchParam, searchParam, searchParam, searchParam);
        }
        const baseJoin = `
      FROM user_reports ur
      LEFT JOIN users reporter ON ur.reporter_id = reporter.id
      LEFT JOIN user_profiles reporterProfile ON reporter.id = reporterProfile.user_id
      LEFT JOIN gender_master reporterGender ON reporterProfile.gender_id = reporterGender.id
      LEFT JOIN users reported ON ur.reported_user_id = reported.id
      LEFT JOIN user_profiles reportedProfile ON reported.id = reportedProfile.user_id
      LEFT JOIN gender_master reportedGender ON reportedProfile.gender_id = reportedGender.id
      ${whereClause}
    `;
        const [countResult] = await query(`SELECT COUNT(DISTINCT ur.id) as total ${baseJoin}`, params);
        const total = countResult.total;
        const reports = await query(`SELECT
        ur.id as report_id,
        ur.reporter_id,
        ur.reported_user_id,
        ur.report_reason_ids,
        ur.report_type,
        ur.description,
        ur.status,
        ur.created_at as reported_date,
        reporter.email as reporter_email,
        reporter.phone as reporter_phone,
        reporter.status as reporter_status,
        reporter.vivaaha_user_id as reporter_vivaaha_user_id,
        reporterProfile.first_name as reporter_first_name,
        reporterProfile.middle_name as reporter_middle_name,
        reporterProfile.last_name as reporter_last_name,
        reporterProfile.gender_id as reporter_gender_id,
        reporterGender.gender_name as reporter_gender_name,
        (
          SELECT photo_url FROM user_photos
          WHERE user_id = reporter.id AND is_primary = 1
          ORDER BY upload_date DESC LIMIT 1
        ) as reporter_profile_image,
        reported.email as reported_email,
        reported.phone as reported_phone,
        reported.status as reported_status,
        reported.vivaaha_user_id as reported_vivaaha_user_id,
        reportedProfile.first_name as reported_first_name,
        reportedProfile.middle_name as reported_middle_name,
        reportedProfile.last_name as reported_last_name,
        reportedProfile.gender_id as reported_gender_id,
        reportedGender.gender_name as reported_gender_name,
        (
          SELECT photo_url FROM user_photos
          WHERE user_id = reported.id AND is_primary = 1
          ORDER BY upload_date DESC LIMIT 1
        ) as reported_profile_image
      ${baseJoin}
      ORDER BY ur.created_at DESC
      LIMIT ? OFFSET ?`, [...params, limit, offset]);
        const reasons = await query(`
      SELECT child.id, child.reason_name, child.parent_id, parent.reason_name as category_name
      FROM report_reasons_master child
      LEFT JOIN report_reasons_master parent ON child.parent_id = parent.id
    `);
        const reasonMap = new Map(reasons.map(reason => [
            Number(reason.id),
            {
                id: reason.id,
                reason_name: reason.reason_name,
                category_id: reason.parent_id,
                category_name: reason.category_name
            }
        ]));
        const getFullName = (firstName, middleName, lastName) => [firstName, middleName, lastName].filter(Boolean).join(" ");
        const formattedReports = reports.map(report => {
            let reasonIds = [];
            try {
                reasonIds = typeof report.report_reason_ids === "string"
                    ? JSON.parse(report.report_reason_ids)
                    : report.report_reason_ids || [];
            }
            catch (error) {
                reasonIds = [];
            }
            return {
                ...
                report_reason_ids: reasonIds,
                report_reasons: reasonIds.map(reasonId => reasonMap.get(Number(reasonId))).filter(Boolean),
                reported_date: report.reported_date,
                reporter: {
                    user_id: report.reporter_id,
                    vivaaha_user_id: report.reporter_vivaaha_user_id,
                    email: report.reporter_email,
                    phone: report.reporter_phone,
                    status: report.reporter_status,
                    first_name: report.reporter_first_name,
                    middle_name: report.reporter_middle_name,
                    last_name: report.reporter_last_name,
                    full_name: getFullName(report.reporter_first_name, report.reporter_middle_name, report.reporter_last_name),
                    gender_id: report.reporter_gender_id,
                    gender_name: report.reporter_gender_name,
                    profile_image: report.reporter_profile_image
                },
                reported_user: {
                    user_id: report.reported_user_id,
                    vivaaha_user_id: report.reported_vivaaha_user_id,
                    email: report.reported_email,
                    phone: report.reported_phone,
                    status: report.reported_status,
                    first_name: report.reported_first_name,
                    middle_name: report.reported_middle_name,
                    last_name: report.reported_last_name,
                    full_name: getFullName(report.reported_first_name, report.reported_middle_name, report.reported_last_name),
                    gender_id: report.reported_gender_id,
                    gender_name: report.reported_gender_name,
                    profile_image: report.reported_profile_image
                }
            };
        });
        res.status(200).json({
...
async function getAllUsersFullReport(req, res) {
    try {
    ...
    `, params);
        ...
        for (const user of users) {
         ...
         WHERE ed.user_id = ?`, [user.id]);
            // Get photos
            const photos = await query(`SELECT * FROM user_photos WHERE user_id = ? ORDER BY is_primary DESC, upload_date DESC`, [user.id]);
         ...
         WHERE ugiv.user_id = ?`, [user.id]);
            // Get subscription details
            const [subscription] = await query(`SELECT us.*, sp.plan_name, sp.price, sp.duration_months, sp.original_price, sp.discount_percentage,
         ...
         LEFT JOIN currency_master cm ON sp.currency_id = cm.id
         WHERE us.user_id = ?
         ORDER BY us.created_at DESC LIMIT 1`, [user.id]);
            processedUsers.push({
                basic: user,
                astro: astro || {},
                family: family || {},
                ...
                subscription: subscription ? Object.assign(Object.assign({}, subscription), { subscription_plan: {
...
async function getUserById(req, res) {
    try {
        ...
        const [profile] = await query(`SELECT u.*, up.*, bg.blood_group, dis.disability_name, hi.health_condition,
              up.diet_id, r.religion_name, c.caste_name, cm.community_name, mt.language_name as mother_tongue,
              g.gender_name, ms.status_name as marital_status, dr.drinking_type, sm.smoking_type,
              ccm.dial_code, ccm.country_name,
              CASE WHEN dv_aadhaar.verification_status = 'verified' THEN 1 ELSE 0 END as aadhaar_verified,
       ...
       WHERE ed.user_id = ?`, [id]);
        // Get photos
        const photos = await query(`SELECT * FROM user_photos WHERE user_id = ? ORDER BY is_primary DESC, upload_date DESC`, [id]);
        // Get government ID details
        const [governmentId] = await query(`SELECT ugiv.*, gitm.id_type_name
       FROM user_government_id_verification ugiv
       LEFT JOIN government_id_type_master gitm ON ugiv.id_type_id = gitm.id
       WHERE ugiv.user_id = ?`, [id]);
        // Get subscription details
        const [subscription] = await query(`SELECT us.*, sp.plan_name, sp.price, sp.duration_months, sp.original_price, sp.discount_percentage,
              sp.is_top_seller, sp.is_best_value, sp.currency_id,
              ssm.status_name as subscription_status, cm.currency_code, cm.symbol, cm.currency_name,
       ...
       LEFT JOIN currency_master cm ON sp.currency_id = cm.id
       WHERE us.user_id = ?
       ORDER BY us.created_at DESC LIMIT 1`, [id]);
        res.json({
            success: true,
            is_fake_profile: isFakeProfile(profile),
            user: {
                basic: profile,
                astro: astro || {},
                family: family || {},
...
async function createUser(req, res) {
    try {
        const { email, password, phone, country_code_id = 1, first_name, middle_name, last_name, gender_id = 1, date_of_birth, } = req.body;
        ...
        const [existing] = await query("SELECT id FROM users WHERE email = ? AND status != 4", [email]);
        if (existing) {
            return res.status(400).json({
                success: false,
        ...
        // Create user
        const userResult = await query("INSERT INTO users (email, password, phone, country_code_id, user_type_id, status) VALUES (?, ?, ?, ?, 1, 1)", [email, password, phone, country_code_id]);
        // Create profile
        await query("INSERT INTO user_profiles (user_id, first_name, middle_name, last_name, gender_id, date_of_birth) VALUES (?, ?, ?, ?, ?, ?)", [userResult.insertId, first_name, middle_name || null, last_name, gender_id, date_of_birth]);
        res.status(201).json({
            success: true,
...
async function updateUser(req, res) {
    try {
        const { id } = req.params;
        const { email, phone, country_code_id, status, first_name, middle_name, last_name, gender_id, date_of_birth, } = req.body;
        ...
        if (profileUpdates.length > 0) {
            ...
            await query(`UPDATE user_profiles SET ${profileUpdates.join(', ')} WHERE user_id = ?`, profileValues);
        }
        res.json({
            success: true,
...
async function deleteUser(req, res) {
    try {
        ...
        await query("UPDATE users SET status = 4, email = ?, phone = NULL WHERE id = ?", [deletedEmail, id]);
        res.json({
            success: true,
...
async function updateUserStatus(req, res) {
    try {
        const { id } = req.params;
        const { status } = req.body; // 1 = active, 2 = inactive
        if (![1, 2, 3].includes(Number(status))) {
            return res.status(400).json({
                success: false,
                message: "Status must be 1 (active), 2 (inactive), or 3 (suspended)",
            });
        }
        const [existing] = await query("SELECT id, status FROM users WHERE id = ? AND user_type_id = 1", [id]);
        if (!existing) {
            return res.status(404).json({ success: false, message: "User not found" });
        }
        if (existing.status === 4) {
            return res.status(400).json({ success: false, message: "Cannot change status of a deleted user" });
        }
        await query("UPDATE users SET status = ? WHERE id = ?", [Number(status), id]);
        const statusMessages = { 1: "User activated successfully", 2: "User deactivated successfully", 3: "User suspended successfully" };
        res.json({
            success: true,
            message: statusMessages[Number(status)],
        });
    }
    catch (error) {
...
async function updateWebsiteContent(req, res) {
    try {
        const { privacy_policy, terms_conditions, refund_policy, safe_policy, be_safe_online, homepage_banner, title, subtitle, description } = req.body;
        // Check if content exists
        const [existing] = await query('SELECT id FROM website_content LIMIT 1');
        if (existing) {
            // Update existing content
            await query(`UPDATE website_content SET
...
async function updateContentField(req, res) {
    try {
        ...
        if (websiteFields.includes(field_name)) {
            ...
            const [existing] = await query('SELECT id FROM website_content LIMIT 1');
            if (existing) {
                await query(`UPDATE website_content SET ${field_name} = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?`, [content, existing.id]);
            }
            else {
                await query(`INSERT INTO website_content (${field_name}) VALUES (?)`, [content]);
            }
        }
            ...
            if (existing) {
                await query(`UPDATE ceo_content SET ${dbField} = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?`, [content, existing.id]);
            }
            else {
                await query(`INSERT INTO ceo_content (${dbField}) VALUES (?)`, [content]);
            }
        }
        else {
            return res.status(400).json({
...
async function updateHomepageBanner(req, res) {
    try {
        ...
        const [existing] = await query('SELECT id FROM website_content LIMIT 1');
        if (existing) {
            await query('UPDATE website_content SET homepage_banner = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?', [JSON.stringify(images), existing.id]);
        }
        else {
            await query('INSERT INTO website_content (homepage_banner) VALUES (?)', [JSON.stringify(images)]);
        }
        res.json({
            success: true,
...
async function uploadCEOImageFile(req, res) {
    try {
        if (!req.file) {
            return res.status(400).json({
                success: false,
        ...
        const [existing] = await query('SELECT id FROM ceo_content LIMIT 1');
        if (existing) {
            await query('UPDATE ceo_content SET ceo_image = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?', [imageUrl, existing.id]);
        }
        else {
            await query('INSERT INTO ceo_content (ceo_image) VALUES (?)', [imageUrl]);
        }
        res.json({
            success: true,
...
exports.subscriptionPlansCRUD = {
    ...
    async getAll(req, res) {
        try {
            ...
            const plans = await query(`SELECT sp.*, cm.currency_code, cm.symbol
         FROM subscription_plans sp
         LEFT JOIN currency_master cm ON sp.currency_id = cm.id
         ${whereClause}
         ORDER BY sp.created_at DESC
         LIMIT ? OFFSET ?`, [...params, parseInt(limit), offset]);
            const [{ total }] = await query(`SELECT COUNT(*) as total FROM subscription_plans sp ${whereClause}`, params);
            res.json({
                success: true,
                data: plans,
                pagination: {
    ...
    async getById(req, res) {
        try {
            const { id } = req.params;
            const [plan] = await query(`SELECT sp.*, cm.currency_code, cm.symbol
         FROM subscription_plans sp
         LEFT JOIN currency_master cm ON sp.currency_id = cm.id
         WHERE sp.id = ?`, [id]);
            if (!plan) {
            ...
            // Get plan features
            const features = await query(`SELECT spf.*, sfm.feature_name, sfm.feature_description
         FROM subscription_plan_features spf
         LEFT JOIN subscription_features_master sfm ON spf.feature_id = sfm.id
         WHERE spf.plan_id = ?`, [id]);
            res.json({
                success: true,
                data: Object.assign(Object.assign({}, plan), { features }),
            });
        }
        catch (error) {
    ...
    async create(req, res) {
        try {
            const { plan_name, duration_months, price, original_price, discount_percentage, currency_id = 1, is_top_seller = 0, is_best_value = 0, user_status_id = 1 } = req.body;
            ...
            const result = await query(`INSERT INTO subscription_plans
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`, [plan_name, duration_months, price, original_price, discount_percentage, currency_id, is_top_seller, is_best_value, user_status_id]);
            res.status(201).json({
                success: true,
    ...
    async update(req, res) {
        try {
            const { id } = req.params;
            const { plan_name, duration_months, price, original_price, discount_percentage, currency_id, is_top_seller, is_best_value, user_status_id } = req.body;
            ...
            await query(`UPDATE subscription_plans SET
         ...
         WHERE id = ?`, [plan_name, duration_months, price, original_price, discount_percentage, currency_id, is_top_seller, is_best_value, user_status_id, id]);
            res.json({
                success: true,
    ...
    async delete(req, res) {
        try {
            ...
            await query("DELETE FROM subscription_plan_features WHERE plan_id = ?", [id]);
...
exports.subscriptionPlanFeaturesCRUD = {
    ...
    async getAll(req, res) {
        try {
            ...
            const features = await query(`SELECT spf.*, sp.plan_name, sfm.feature_name, sfm.feature_description
         FROM subscription_plan_features spf
         ...
         LIMIT ? OFFSET ?`, [...params, parseInt(limit), offset]);
            const [{ total }] = await query(`SELECT COUNT(*) as total FROM subscription_plan_features spf
         LEFT JOIN subscription_plans sp ON spf.plan_id = sp.id
         LEFT JOIN subscription_features_master sfm ON spf.feature_id = sfm.id
         ${whereClause}`, params);
            res.json({
    ...
    async getById(req, res) {
        try {
            const { id } = req.params;
            const [feature] = await query(`SELECT spf.*, sp.plan_name, sfm.feature_name, sfm.feature_description
         FROM subscription_plan_features spf
         LEFT JOIN subscription_plans sp ON spf.plan_id = sp.id
         LEFT JOIN subscription_features_master sfm ON spf.feature_id = sfm.id
         WHERE spf.id = ?`, [id]);
    ...
    async create(req, res) {
        try {
            const { plan_id, feature_id, feature_value, user_status_id = 1 } = req.body;
            ...
            const result = await query(`INSERT INTO subscription_plan_features
         (plan_id, feature_id, feature_value, user_status_id)
         VALUES (?, ?, ?, ?)`, [plan_id, feature_id, feature_value, user_status_id]);
            res.status(201).json({
                success: true,
    ...
    async update(req, res) {
        try {
            const { id } = req.params;
            const { plan_id, feature_id, feature_value, user_status_id } = req.body;
            ...
            await query(`UPDATE subscription_plan_features SET
         plan_id = COALESCE(?, plan_id),
         feature_id = COALESCE(?, feature_id),
         feature_value = COALESCE(?, feature_value),
         user_status_id = COALESCE(?, user_status_id)
         WHERE id = ?`, [plan_id, feature_id, feature_value, user_status_id, id]);
            res.json({
                success: true,
...
exports.subscriptionFeaturesMasterCRUD = {
    // Get All Features
    async getAll(req, res) {
        try {
            const { page = 1, limit = 10, search = "" } = req.query;
            ...
            const features = await query(`SELECT * FROM subscription_features_master
         ${whereClause}
         ORDER BY created_at DESC
         LIMIT ? OFFSET ?`, [...params, parseInt(limit), offset]);
            const [{ total }] = await query(`SELECT COUNT(*) as total FROM subscription_features_master ${whereClause}`, params);
            res.json({
                success: true,
                data: features,
                pagination: {
    ...
    async getById(req, res) {
        try {
            const { id } = req.params;
            const [feature] = await query("SELECT * FROM subscription_features_master WHERE id = ?", [id]);
            if (!feature) {
                return res.status(404).json({
                    success: false,
    ...
    async create(req, res) {
        try {
            const { feature_name, feature_description, user_status_id = 1 } = req.body;
            if (!feature_name) {
                return res.status(400).json({
                    success: false,
            ...
            const result = await query(`INSERT INTO subscription_features_master
         (feature_name, feature_description, user_status_id)
         VALUES (?, ?, ?)`, [feature_name, feature_description, user_status_id]);
            res.status(201).json({
                success: true,
    ...
    async update(req, res) {
        try {
            const { id } = req.params;
            const { feature_name, feature_description, user_status_id } = req.body;
            ...
            await query(`UPDATE subscription_features_master SET
         feature_name = COALESCE(?, feature_name),
         feature_description = COALESCE(?, feature_description),
         user_status_id = COALESCE(?, user_status_id)
         WHERE id = ?`, [feature_name, feature_description, user_status_id, id]);
            res.json({
                success: true,
...
exports.subscriptionAddonsMasterCRUD = {
    // Get All Addons
    async getAll(req, res) {
        try {
            const addons = await query(`SELECT sam.*, cm.currency_code, cm.symbol
    ...
    async getById(req, res) {
        try {
            const { id } = req.params;
            const [addon] = await query(`SELECT sam.*, cm.currency_code, cm.symbol
         FROM subscription_addons_master sam
         LEFT JOIN currency_master cm ON sam.currency_id = cm.id
         WHERE sam.id = ?`, [id]);
            if (!addon) {
    ...
    async create(req, res) {
        try {
            const { addon_name, addon_description, price, currency_id = 1, is_active = 1, availability = 'post_purchase_only' } = req.body;
            if (!addon_name || !price) {
                return res.status(400).json({
                    success: false,
            ...
            const result = await query(`INSERT INTO subscription_addons_master
         (addon_name, addon_description, price, currency_id, is_active, availability)
         VALUES (?, ?, ?, ?, ?, ?)`, [addon_name, addon_description, price, currency_id, is_active, availability]);
            res.status(201).json({
                success: true,
    ...
    async update(req, res) {
        try {
            const { id } = req.params;
            const { addon_name, addon_description, price, currency_id, is_active, availability } = req.body;
            ...
            await query(`UPDATE subscription_addons_master SET
         ...
         WHERE id = ?`, [addon_name, addon_description, price, currency_id, is_active, availability, id]);
            res.json({
                success: true,
...
async function getSuccessStoryById(req, res) {
    try {
        const { id } = req.params;
        const [story] = await query("SELECT * FROM success_stories WHERE id = ?", [id]);
        if (!story) {
            return res.status(404).json({
                success: false,
...
async function approveSuccessStory(req, res) {
    try {
        const { id } = req.params;
        ...
        await query("UPDATE success_stories SET status = 'approved', is_published = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?", [is_published, id]);
        res.json({
            success: true,
...
async function rejectSuccessStory(req, res) {
    try {
        const { id } = req.params;
        const [existing] = await query("SELECT id FROM success_stories WHERE id = ?", [id]);
        if (!existing) {
        ...
        await query("UPDATE success_stories SET status = 'rejected', is_published = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?", [id]);
        res.json({
            success: true,
...
async function updateSuccessStoryStatus(req, res) {
    try {
        ...
        await query("UPDATE success_stories SET status = ?, is_published = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?", [status, is_published ? 1 : 0, id]);
        res.json({
            success: true,
...
async function updateSuccessStory(req, res) {
    try {
        const { id } = req.params;
        const { user_name, partner_name, user_email, partner_email, first_met_date, wedding_date, do_not_disclose, not_yet_fixed, story_content, photo_url, agree_to_terms, feature_in_stories, status, is_published } = req.body;
        const [existing] = await query("SELECT id FROM success_stories WHERE id = ?", [id]);
        if (!existing) {
            return res.status(404).json({
                success: false,
        ...
        values.push(id);
        await query(`UPDATE success_stories SET ${updates.join(', ')} WHERE id = ?`, values);
        res.json({
            success: true,
...
async function uploadSuccessStoryPhoto(req, res) {
    try {
        const { id } = req.params;
        ...
        try {
            ...
            await query("UPDATE success_stories SET photo_url = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?", [photoUrl, id]);
            res.json({
                success: true,
...
async function deleteSuccessStoryPhoto(req, res) {
    try {
        const { id } = req.params;
        // Check if success story exists
        ...
        await query("UPDATE success_stories SET photo_url = NULL, updated_at = CURRENT_TIMESTAMP WHERE id = ?", [id]);
        res.json({
            success: true,
...
async function updateSuccessStoryWithPhoto(req, res) {
    try {
        const { id } = req.params;
        const { user_name, partner_name, user_email, partner_email, first_met_date, wedding_date, do_not_disclose, not_yet_fixed, story_content, agree_to_terms, feature_in_stories, status, is_published } = req.body;
...
async function updateUserProfile(req, res) {
    try {
        const { id } = req.params;
        const { height, weight, marital_status_id, about_myself, blood_group_id, diet_id, health_info_id, disability_id, smoking_id, drinking_id, occupation, company_name, annual_income } = req.body;
        // Check if user exists
        const [existing] = await query("SELECT id FROM users WHERE id = ?", [id]);
        if (!existing) {
            return res.status(404).json({
        ...
        // Update user profile
        await query(`UPDATE user_profiles SET
       ...
       WHERE user_id = ?`, [height, weight, marital_status_id, about_myself, blood_group_id,
        ...
        if (occupation || company_name || annual_income) {
            ...
            if (existingCareer) {
                await query("UPDATE career_details SET occupation = COALESCE(?, occupation), company_name = COALESCE(?, company_name), annual_income = COALESCE(?, annual_income) WHERE user_id = ?", [occupation, company_name, annual_income, id]);
            }
            else {
                await query("INSERT INTO career_details (user_id, occupation, company_name, annual_income, currency_id) VALUES (?, ?, ?, ?, 1)", [id, occupation, company_name, annual_income]);
            }
        }
        res.json({
            success: true,
...
async function updateUserReligiousInfo(req, res) {
    try {
        const { id } = req.params;
        ...
        await query(`UPDATE user_profiles SET religion_id = ?, mother_tongue_id = ?, caste_id = ?
       WHERE user_id = ?`, [religion_id, mother_tongue_id || null, caste_id || null, id]);
        // Update or create astro details for gothra
        if (gothra_id) {
            const [existingAstro] = await query("SELECT id FROM astro_details WHERE user_id = ?", [id]);
            if (existingAstro) {
                await query("UPDATE astro_details SET gothra_id = ? WHERE user_id = ?", [gothra_id, id]);
            }
            else {
                await query("INSERT INTO astro_details (user_id, gothra_id) VALUES (?, ?)", [id, gothra_id]);
            }
        }
        res.json({
            success: true,
...
async function updateUserGovernmentId(req, res) {
    try {
        const { id } = req.params;
        ...
        const [existingGovId] = await query("SELECT id FROM user_government_id_verification WHERE user_id = ?", [id]);
        if (existingGovId) {
            // Update existing record
            await query("UPDATE user_government_id_verification SET id_type_id = ?, id_number = ?, is_verified = FALSE, updated_at = CURRENT_TIMESTAMP WHERE user_id = ?", [id_type_id, id_number, id]);
        }
        else {
            // Create new record
            await query("INSERT INTO user_government_id_verification (user_id, id_type_id, id_number, is_verified) VALUES (?, ?, ?, FALSE)", [id, id_type_id, id_number]);
        }
        res.json({
            success: true,
...
async function updateUserBasic(req, res) {
    try {
        const { id } = req.params;
        const { first_name, middle_name, last_name, date_of_birth, height, weight, marital_status_id, has_children, number_of_children, lives_with_family, blood_group_id, profile_managed_by_id, diet_id, health_info_id, disability_id, smoking_id, drinking_id } = req.body;
        // Check if user exists
        const [existing] = await query("SELECT id FROM users WHERE id = ?", [id]);
        if (!existing) {
            return res.status(404).json({
        ...
        if (updates.length > 0) {
            values.push(id);
            await query(`UPDATE user_profiles SET ${updates.join(', ')} WHERE user_id = ?`, values);
        }
...
async function updateUserAbout(req, res) {
    try {
        ...
        await query(`UPDATE user_profiles SET about_myself = ?, disability_id = ?, blood_group_id = ?,
       diet_id = ?, health_info_id = ? WHERE user_id = ?`, [about_myself, disability_id, blood_group_id, dietIdValue, health_info_id, id]);
...
async function updateUserAstro(req, res) {
    try {
        const { id } = req.params;
        const { country_of_birth_id, state_of_birth, city_of_birth, birth_time, birth_time_type, manglik_status, dosham, gothra_id, rasi_id, nakshatra_id } = req.body;
        // Check if user exists
        const [existing] = await query("SELECT id FROM users WHERE id = ?", [id]);
        if (!existing) {
            return res.status(404).json({
        ...
        const [existingAstro] = await query(`SELECT id FROM astro_details WHERE user_id = ?`, [id]);
        if (existingAstro) {
            await query(`UPDATE astro_details SET country_of_birth_id = ?, state_of_birth = ?, city_of_birth = ?,
         birth_time = ?, birth_time_type = ?, manglik_status = ?, dosham = ?, gothra_id = ?,
         rasi_id = ?, nakshatra_id = ? WHERE user_id = ?`, [country_of_birth_id, state_of_birth, city_of_birth, birth_time,
                validBirthTimeType, manglik_status, dosham, gothra_id, rasi_id, nakshatra_id, id]);
        }
        else {
            await query(`INSERT INTO astro_details (user_id, country_of_birth_id, state_of_birth, city_of_birth,
         birth_time, birth_time_type, manglik_status, dosham, gothra_id, rasi_id, nakshatra_id)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [id, country_of_birth_id, state_of_birth, city_of_birth, birth_time,
...
async function updateUserFamily(req, res) {
    try {
        const { id } = req.params;
        const { father_name, father_occupation_id, mother_name, mother_occupation_id, no_of_sisters, no_of_brothers, family_country_id, family_state, family_financial_status_id, family_type_id, family_values_id } = req.body;
        // Check if user exists
        const [existing] = await query("SELECT id FROM users WHERE id = ?", [id]);
        if (!existing) {
            return res.status(404).json({
        ...
        if (existingFamily) {
            await query(`UPDATE family_details SET father_name = ?, father_occupation_id = ?, mother_name = ?,
         ...
         WHERE user_id = ?`, [father_name, father_occupation_id, mother_name, mother_occupation_id, no_of_sisters,
                no_of_brothers, family_country_id, family_state, family_financial_status_id,
                family_type_id, family_values_id, id]);
        }
        else {
            await query(`INSERT INTO family_details (user_id, father_name, father_occupation_id, mother_name,
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [id, father_name, father_occupation_id, mother_name, mother_occupation_id, no_of_sisters,
                no_of_brothers, family_country_id, family_state, family_financial_status_id,
...
async function updateUserCareer(req, res) {
    try {
        const { id } = req.params;
        const { highest_qualification, college_attended, college_attended_2, working_with_id, working_as, employer_name, annual_income, income_type, keep_income_private } = req.body;
        // Check if user exists
        const [existing] = await query("SELECT id FROM users WHERE id = ?", [id]);
        if (!existing) {
            return res.status(404).json({
        ...
        const [existingCareer] = await query(`SELECT id FROM career_details WHERE user_id = ?`, [id]);
        if (existingCareer) {
            await query(`UPDATE career_details SET highest_qualification = ?, college_attended = ?,
         working_with_id = ?, working_as = ?, employer_name = ?, annual_income = ?, income_type = ?,
         keep_income_private = ? WHERE user_id = ?`, [highest_qualification, college_attended, working_with_id, working_as, employer_name,
                annual_income, income_type, keep_income_private, id]);
        }
        else {
            await query(`INSERT INTO career_details (user_id, highest_qualification, college_attended,
         working_with_id, working_as, employer_name, annual_income, income_type, keep_income_private, currency_id)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 1)`, [id, highest_qualification, college_attended, working_with_id, working_as,
        ...
        if (college_attended || college_attended_2) {
            ...
            if (eduExists) {
                await query(`UPDATE education_details SET institution_name = ?, institution_name_2 = ? WHERE user_id = ?`, [college_attended, college_attended_2, id]);
            }
            else {
                await query(`INSERT INTO education_details (user_id, institution_name, institution_name_2, education_level_id) VALUES (?, ?, ?, 1)`, [id, college_attended, college_attended_2]);
            }
        }
...
async function updateUserLocation(req, res) {
    try {
        ...
        if (existingLocation) {
            await query(`UPDATE location_details SET current_residence = ?, residency_status = ?,
         state_living_in = ?, state_id = ?, city_id = ?, country_id = ?, zip_code = ?, latitude = ?, longitude = ? WHERE user_id = ?`, [current_residence, residency_status, state_living_in, state_id, city_id, country_id, zip_code, latitude, longitude, id]);
        }
        else {
            await query(`INSERT INTO location_details (user_id, current_residence, residency_status,
         state_living_in, state_id, city_id, country_id, zip_code, latitude, longitude) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [id, current_residence, residency_status, state_living_in, state_id, city_id, country_id, zip_code, latitude, longitude]);
        }
        ...
        if (grew_up_in !== undefined || ethnic_origin_id !== undefined) {
            ...
            if (careerExists) {
                ...
                if (updates.length > 0) {
                    values.push(id);
                    await query(`UPDATE career_details SET ${updates.join(', ')} WHERE user_id = ?`, values);
                }
            }
            else {
                await query(`INSERT INTO career_details (user_id, grew_up_in_ids, ethnic_origin_id, currency_id) VALUES (?, ?, ?, 1)`, [id, JSON.stringify(grew_up_in || []), ethnic_origin_id || null]);
            }
        }
...
async function updateCompleteUserProfile(req, res) {
    try {
        const { id } = req.params;
        const { 
        // Basic user info
        ...
        // Profile details
        profile_for, first_name, middle_name, last_name, gender_id, date_of_birth, height, weight, marital_status_id, religion_id, caste_id, community_id, mother_tongue_id, blood_group_id, diet_id, health_info_id, disability_id, smoking_id, drinking_id, profile_managed_by_id, about_myself, has_children, number_of_children, lives_with_family, family_location, country_of_birth_id, state_of_birth, city_of_birth, birth_time, birth_time_type, manglik_status, dosham, gothra_id, rasi_id, nakshatra_id, 
        // Family details
        father_name, father_occupation_id, mother_name, mother_occupation_id, no_of_sisters, no_of_brothers, family_country_id, family_state, family_financial_status_id, family_type_id, family_values_id, 
        // Career details
        highest_qualification, college_attended, working_with_id, working_as, employer_name, annual_income, income_type, keep_income_private, profession_id, 
        // Location details
        current_residence, residency_status, state_living_in, state_id, city_id, country_id, zip_code, latitude, longitude, grew_up_in, ethnic_origin_id, 
        // Education details
        education_level_id, education_area_id, field_of_study, graduation_year, graduation_year_2, institution_name, institution_name_2, college_attended_2, 
        // Government ID
        ...
        if (country_of_birth_id || state_of_birth || city_of_birth || birth_time || birth_time_type ||
            ...
            if (existingAstro) {
                const astroUpdates = [];
                const astroValues = [];
                if (country_of_birth_id) {
                    astroUpdates.push('country_of_birth_id = ?');
                    astroValues.push(country_of_birth_id);
                }
                if (state_of_birth) {
                    astroUpdates.push('state_of_birth = ?');
                    astroValues.push(state_of_birth);
                }
                if (city_of_birth) {
                    astroUpdates.push('city_of_birth = ?');
                    astroValues.push(city_of_birth);
                }
                if (birth_time) {
                    astroUpdates.push('birth_time = ?');
                    astroValues.push(birth_time);
                }
                if (validBirthTimeType) {
                    astroUpdates.push('birth_time_type = ?');
                    astroValues.push(validBirthTimeType);
                }
                if (manglik_status !== undefined) {
                    astroUpdates.push('manglik_status = ?');
                    astroValues.push(manglik_status);
                }
                if (dosham !== undefined) {
                    astroUpdates.push('dosham = ?');
                    astroValues.push(dosham);
                }
                if (gothra_id) {
                    astroUpdates.push('gothra_id = ?');
                    astroValues.push(gothra_id);
                }
                if (rasi_id) {
                    astroUpdates.push('rasi_id = ?');
                    astroValues.push(rasi_id);
                }
                if (nakshatra_id) {
                    astroUpdates.push('nakshatra_id = ?');
                    astroValues.push(nakshatra_id);
                }
                if (astroUpdates.length > 0) {
                    astroValues.push(id);
                    await query(`UPDATE astro_details SET ${astroUpdates.join(', ')} WHERE user_id = ?`, astroValues);
                }
            }
            else {
                await query(`INSERT INTO astro_details (user_id, country_of_birth_id, state_of_birth, city_of_birth,
        ...
        if (father_name || father_occupation_id || mother_name || mother_occupation_id ||
            ...
            if (existingFamily) {
                ...
                const familyValues = [];
                if (father_name) {
                    familyUpdates.push('father_name = ?');
                    familyValues.push(father_name);
                }
                if (father_occupation_id) {
                    familyUpdates.push('father_occupation_id = ?');
                    familyValues.push(father_occupation_id);
                }
                if (mother_name) {
                    familyUpdates.push('mother_name = ?');
                    familyValues.push(mother_name);
                }
                if (mother_occupation_id) {
                    familyUpdates.push('mother_occupation_id = ?');
                    familyValues.push(mother_occupation_id);
                }
                if (no_of_sisters !== undefined) {
                    familyUpdates.push('no_of_sisters = ?');
                    familyValues.push(no_of_sisters);
                }
                if (no_of_brothers !== undefined) {
                    familyUpdates.push('no_of_brothers = ?');
                    familyValues.push(no_of_brothers);
                }
                if (family_country_id) {
                    familyUpdates.push('family_country_id = ?');
                    familyValues.push(family_country_id);
                }
                if (family_state) {
                    familyUpdates.push('family_state = ?');
                    familyValues.push(family_state);
                }
                if (family_financial_status_id) {
                    familyUpdates.push('family_financial_status_id = ?');
                    familyValues.push(family_financial_status_id);
                }
                if (family_type_id) {
                    familyUpdates.push('family_type_id = ?');
                    familyValues.push(family_type_id);
                }
                if (family_values_id) {
                    familyUpdates.push('family_values_id = ?');
                    familyValues.push(family_values_id);
                }
                if (familyUpdates.length > 0) {
                    familyValues.push(id);
                    await query(`UPDATE family_details SET ${familyUpdates.join(', ')} WHERE user_id = ?`, familyValues);
                }
            }
            else {
                await query(`INSERT INTO family_details (user_id, father_name, father_occupation_id, mother_name,
           ...
           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1)`, [id, father_name, father_occupation_id, mother_name, mother_occupation_id, no_of_sisters,
                    no_of_brothers, family_country_id, family_state, family_financial_status_id,
                    family_type_id, family_values_id]);
            }
        }
        ...
        if (highest_qualification || college_attended || college_attended_2 || working_with_id ||
            ...
            if (existingCareer) {
                ...
                if (highest_qualification) {
                    careerUpdates.push('highest_qualification = ?');
                    careerValues.push(highest_qualification);
                }
                if (college_attended) {
                    careerUpdates.push('college_attended = ?');
                    careerValues.push(college_attended);
                }
                if (working_with_id) {
                    careerUpdates.push('working_with_id = ?');
                    careerValues.push(working_with_id);
                }
                if (working_as) {
                    careerUpdates.push('working_as = ?');
                    careerValues.push(working_as);
                }
                if (employer_name) {
                    careerUpdates.push('employer_name = ?');
                    careerValues.push(employer_name);
                }
                if (annual_income !== undefined) {
                    careerUpdates.push('annual_income = ?');
                    careerValues.push(annual_income);
                }
                if (income_type) {
                    careerUpdates.push('income_type = ?');
                    careerValues.push(income_type);
                }
                if (keep_income_private !== undefined) {
                    careerUpdates.push('keep_income_private = ?');
                    careerValues.push(keep_income_private);
                }
                if (profession_id) {
                    careerUpdates.push('profession_id = ?');
                    careerValues.push(profession_id);
                }
                if (grew_up_in) {
                    careerUpdates.push('grew_up_in_ids = ?');
                    careerValues.push(JSON.stringify(grew_up_in));
                }
                if (ethnic_origin_id) {
                    careerUpdates.push('ethnic_origin_id = ?');
                    careerValues.push(ethnic_origin_id);
                }
                if (careerUpdates.length > 0) {
                    careerValues.push(id);
                    await query(`UPDATE career_details SET ${careerUpdates.join(', ')} WHERE user_id = ?`, careerValues);
                }
            }
            else {
                await query(`INSERT INTO career_details (user_id, highest_qualification, college_attended, working_with_id,
           ...
           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 1, ?, ?, ?)`, [id, highest_qualification, college_attended, working_with_id, working_as, employer_name,
        ...
        if (current_residence || residency_status || state_living_in || state_id ||
            ...
            if (existingLocation) {
                ...
                if (current_residence) {
                    locationUpdates.push('current_residence = ?');
                    locationValues.push(current_residence);
                }
                if (residency_status) {
                    locationUpdates.push('residency_status = ?');
                    locationValues.push(residency_status);
                }
                if (state_living_in) {
                    locationUpdates.push('state_living_in = ?');
                    locationValues.push(state_living_in);
                }
                if (state_id) {
                    locationUpdates.push('state_id = ?');
                    locationValues.push(state_id);
                }
                if (city_id) {
                    locationUpdates.push('city_id = ?');
                    locationValues.push(city_id);
                }
                if (country_id) {
                    locationUpdates.push('country_id = ?');
                    locationValues.push(country_id);
                }
                if (zip_code) {
                    locationUpdates.push('zip_code = ?');
                    locationValues.push(zip_code);
                }
                if (latitude !== undefined) {
                    locationUpdates.push('latitude = ?');
                    locationValues.push(latitude);
                }
                if (longitude !== undefined) {
                    locationUpdates.push('longitude = ?');
                    locationValues.push(longitude);
                }
                if (locationUpdates.length > 0) {
                    locationValues.push(id);
                    await query(`UPDATE location_details SET ${locationUpdates.join(', ')} WHERE user_id = ?`, locationValues);
                }
            }
            else {
                await query(`INSERT INTO location_details (user_id, current_residence, residency_status,
           state_living_in, state_id, city_id, country_id, zip_code, latitude, longitude)
           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [id, current_residence, residency_status, state_living_in, state_id, city_id,
        ...
        if (education_level_id || education_area_id || field_of_study || graduation_year || graduation_year_2 || institution_name || college_attended_2 || institution_name_2) {
            ...
            if (existingEducation) {
                ...
                if (education_level_id) {
                    educationUpdates.push('education_level_id = ?');
                    educationValues.push(education_level_id);
                }
                if (education_area_id) {
                    educationUpdates.push('education_area_id = ?');
                    educationValues.push(education_area_id);
                }
                if (field_of_study) {
                    educationUpdates.push('field_of_study = ?');
                    educationValues.push(field_of_study);
                }
                if (graduation_year) {
                    educationUpdates.push('graduation_year = ?');
                    educationValues.push(graduation_year);
                }
                if (graduation_year_2) {
                    educationUpdates.push('graduation_year_2 = ?');
                    educationValues.push(graduation_year_2);
                }
                if (institution_name || college_attended) {
                    educationUpdates.push('institution_name = ?');
                    educationValues.push(institution_name || college_attended);
                }
                const inst2 = institution_name_2 || college_attended_2;
                if (inst2) {
                    educationUpdates.push('institution_name_2 = ?');
                    educationValues.push(inst2);
                }
                if (educationUpdates.length > 0) {
                    educationValues.push(id);
                    await query(`UPDATE education_details SET ${educationUpdates.join(', ')} WHERE user_id = ?`, educationValues);
                }
            }
            else {
                const inst2 = institution_name_2 || college_attended_2;
                await query(`INSERT INTO education_details (user_id, education_level_id, education_area_id,
           field_of_study, institution_name, institution_name_2, graduation_year, graduation_year_2)
           VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [id, education_level_id || 1, education_area_id, field_of_study,
        ...
        if (id_type_id || id_number) {
            ...
            if (existingGovId) {
                ...
                const govIdValues = [];
                if (id_type_id) {
                    govIdUpdates.push('id_type_id = ?');
                    govIdValues.push(id_type_id);
                }
                if (id_number) {
                    govIdUpdates.push('id_number = ?');
                    govIdValues.push(id_number);
                }
                govIdUpdates.push('is_verified = FALSE, updated_at = CURRENT_TIMESTAMP');
                if (govIdUpdates.length > 0) {
                    govIdValues.push(id);
                    await query(`UPDATE user_government_id_verification SET ${govIdUpdates.join(', ')} WHERE user_id = ?`, govIdValues);
                }
            }
...
async function createCompleteUserProfile(req, res) {
    try {
        const { 
        // Basic user info
        email, phone, country_code_id = 1, 
        // Profile details
        profile_for, first_name, middle_name, last_name, gender_id, date_of_birth, height, weight, marital_status_id, religion_id, caste_id, community_id, mother_tongue_id, blood_group_id, diet_id, health_info_id, disability_id, smoking_id, drinking_id, profile_managed_by_id, about_myself, has_children, number_of_children, lives_with_family, family_location, 
        // Astro details
        country_of_birth_id, state_of_birth, city_of_birth, birth_time, birth_time_type, manglik_status, dosham, gothra_id, rasi_id, nakshatra_id, 
        // Family details
        father_name, father_occupation_id, mother_name, mother_occupation_id, no_of_sisters, no_of_brothers, family_country_id, family_state, family_financial_status_id, family_type_id, family_values_id, 
        // Career details
        highest_qualification, college_attended, working_with_id, working_as, employer_name, annual_income, income_type, keep_income_private, work_type, occupation, company_name, 
        // Location details
        current_residence, residency_status, state_living_in, state_id, city_id, country_id, zip_code, latitude, longitude, grew_up_in, ethnic_origin_id, 
        // Education details
        education_level_id, education_area_id, field_of_study, graduation_year, graduation_year_2, institution_name, institution_name_2, college_name_2, 
        // Government ID
        id_type_id, id_number, 
        // Hobbies
        hobby_ids } = req.body;
        ...
        if (phone) {
            const [existingPhone] = await query("SELECT id FROM users WHERE phone = ? AND status != 4", [phone]);
            if (existingPhone) {
                return res.status(400).json({
                    success: false,
        ...
        const userResult = await query("INSERT INTO users (email, password, phone, vivaaha_user_id, country_code_id, user_type_id, status, email_verified, phone_verified) VALUES (?, ?, ?, ?, ?, 1, 1, 1, 1)", [email, hashedPassword, phone, vivaaha_user_id, country_code_id]);
        ...
        await query(`INSERT INTO user_profiles (user_id, first_name, middle_name, last_name, gender_id, date_of_birth, age, height, weight,
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [userId, first_name, middle_name, last_name, gender_id, date_of_birth, age, height, weight,
        ...
        if (country_of_birth_id || state_of_birth || city_of_birth) {
            await query(`INSERT INTO astro_details (user_id, country_of_birth_id, state_of_birth, city_of_birth,
         birth_time, birth_time_type, manglik_status, dosham, gothra_id, rasi_id, nakshatra_id)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [userId, country_of_birth_id, state_of_birth, city_of_birth, birth_time,
                validBirthTimeType, manglik_status, dosham, gothra_id, rasi_id, nakshatra_id]);
        }
        ...
        if (father_name || mother_name) {
         ...
         mother_occupation_id, no_of_sisters, no_of_brothers, family_country_id, family_state,
         family_financial_status_id, family_type_id, family_values_id, family_status_id)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1)`, [userId, father_name, father_occupation_id, mother_name, mother_occupation_id, no_of_sisters,
                no_of_brothers, family_country_id, family_state, family_financial_status_id,
                family_type_id, family_values_id]);
        }
        ...
        if (highest_qualification || working_with_id || employer_name || work_type || occupation || company_name) {
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 1, ?, ?, 1, ?, ?)`, [userId, highest_qualification, college_attended, working_with_id, working_as || occupation,
        ...
        if (current_residence || city_id || country_id) {
            await query(`INSERT INTO location_details (user_id, current_residence, residency_status,
         state_living_in, state_id, city_id, country_id, zip_code, latitude, longitude)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [userId, current_residence, residency_status, state_living_in, state_id, city_id,
                country_id || 1, zip_code, latitude, longitude]);
        }
        // Create address details if city provided (similar to user signup)
        if (current_residence || city_id) {
            await query("INSERT INTO address_details (user_id, address_type, city, city_id, country_id) VALUES (?, 'current', ?, ?, ?)", [userId, current_residence, city_id, country_id || 1]);
        }
        ...
        if (education_level_id || field_of_study || college_attended || institution_name || college_name_2 || institution_name_2) {
            ...
            await query(`INSERT INTO education_details (user_id, education_level_id, education_area_id,
         field_of_study, institution_name, institution_name_2, graduation_year, graduation_year_2)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [userId, education_level_id || 1, education_area_id, field_of_study,
        ...
        if (id_type_id && id_number) {
            await query("INSERT INTO user_government_id_verification (user_id, id_type_id, id_number, is_verified) VALUES (?, ?, ?, FALSE)", [userId, id_type_id, id_number]);
        }
        // Send welcome email with password
        try {
...
async function adminUploadUserPhoto(req, res) {
    try {
...
async function adminUploadMultipleUserPhotos(req, res) {
    try {
        const { id: userId } = req.params;
        // Check if user exists
        const [userExists] = await query("SELECT id FROM users WHERE id = ?", [userId]);
...
async function adminGetUserPhotos(req, res) {
    try {
        const { id: userId } = req.params;
        // Check if user exists
        const [userExists] = await query("SELECT id FROM users WHERE id = ?", [userId]);
...
async function adminDeleteUserPhoto(req, res) {
    try {
...
async function adminSetUserPrimaryPhoto(req, res) {
    try {
        const { id: userId, photoId } = req.params;
        // Check if user exists
        const [userExists] = await query("SELECT id FROM users WHERE id = ?", [userId]);
...
async function approveRefundRequest(req, res) {
    try {
        ...
        const [existing] = await query("SELECT * FROM refund_requests WHERE id = ? AND refund_status = 'pending'", [id]);
        if (!existing) {
            return res.status(404).json({
                success: false,
        ...
        await query(`UPDATE refund_requests SET
       refund_status = 'approved',
       refund_amount = ?,
       admin_notes = ?,
       processed_at = CURRENT_TIMESTAMP
       WHERE id = ?`, [refund_amount, admin_notes, id]);
        // Cancel the subscription
        await query("UPDATE user_subscriptions SET subscription_status_id = 3, is_active = FALSE WHERE id = ?", [existing.subscription_id]);
        res.json({
            success: true,
...
async function rejectRefundRequest(req, res) {
    try {
        ...
        // Check if refund request exists and is pending
        const [existing] = await query("SELECT id FROM refund_requests WHERE id = ? AND refund_status = 'pending'", [id]);
        if (!existing) {
            return res.status(404).json({
                success: false,
                message: "Pending refund request not found",
...
async function updateRefundRequestStatus(req, res) {
    try {
        const { id } = req.params;
        const { status, refund_amount, admin_notes = "", razorpay_refund_id } = req.body;
        ...
        await query(`UPDATE refund_requests SET ${updateFields.join(", ")} WHERE id = ?`, updateValues);
...
async function getRefundStatistics(req, res) {
    try {
    ...
    try {
        ...
        res.json({
            ...
            data: settings || {
                ...
                audio_restrictions: 0, //1 is restrictions enable, 0 is restrictions disable
                video_restrictions: 0, //1 is restrictions enable, 0 is restrictions disable
            }
        });
    }
    catch (error) {
...
// generated one.
let generalSettingsWritableColumns = null;
async function getWritableGeneralSettingsColumns() {
    if (generalSettingsWritableColumns)
        return generalSettingsWritableColumns;
    const columns = await query(`SELECT COLUMN_NAME, EXTRA, GENERATION_EXPRESSION
...
function normalizeRestrictionFlag(value) {
...
async function updateGeneralSettings(req, res) {
    try {
        const { site_name, site_logo, primary_color, secondary_color, email_1, email_2, phone_number, address, facebook_url, instagram_url, twitter_url, linkedin_url, youtube_url, threads_url, smtp_host, smtp_port, smtp_username, smtp_password, smtp_encryption, smtp_from_email, smtp_from_name, subscription_restrictions, audio_restrictions, video_restrictions } = req.body;
        ...
        if (existing) {
            ...
            const setClause = writes
                ...
                .join(',\n         ');
            await query(`UPDATE general_settings SET
         ${setClause},
         updated_at = CURRENT_TIMESTAMP
         WHERE id = ?`, [...writes.map((write) => write.value), existing.id]);
        }
        else {
            ...
            const insertValues = writes.map((write) => {
                if (write.value !== null && write.value !== undefined)
                    return write.value;
                return insertDefaults[write.column] !== undefined ? insertDefaults[write.column] : null;
            });
            await query(`INSERT INTO general_settings (${insertColumns.join(', ')})
        ...
        (0, subscriptionAccess_1.invalidateSubscriptionRestrictionsCache)();
        res.json({
            success: true,
            message: "General settings updated successfully"
        });
        // Reset email transporter so next send picks up new SMTP settings
        EmailService_1.EmailService.resetTransporter();
    }
    catch (error) {
...
async function uploadSiteLogoFile(req, res) {
    try {
        if (!req.file) {
            return res.status(400).json({
                success: false,
        ...
        const [existing] = await query('SELECT id FROM general_settings LIMIT 1');
        if (existing) {
            await query('UPDATE general_settings SET site_logo = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?', [logoUrl, existing.id]);
        }
        else {
            ...
            await query(`INSERT INTO general_settings (${seedWrites.map((seed) => seed.column).join(', ')})
         VALUES (${seedWrites.map(() => '?').join(', ')})`, seedWrites.map((seed) => seed.value));
        }
        res.json({
            success: true,
...
async function getAdminProfile(req, res) {
    try {
        ...
        const [admin] = await query(`SELECT u.id, u.email, u.phone, u.created_at,
       ...
       FROM users u
       LEFT JOIN user_profiles up ON u.id = up.user_id
       WHERE u.id = ? AND u.user_type_id = 2`, [adminId]);
        if (!admin) {
            return res.status(404).json({
                success: false,
...
async function updateAdminProfile(req, res) {
    try {
        ...
        const [existing] = await query("SELECT id FROM users WHERE id = ? AND user_type_id = 2", [adminId]);
        if (!existing) {
            return res.status(404).json({
                success: false,
                message: "Admin not found",
        ...
        if (phone !== undefined) {
            await query("UPDATE users SET phone = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?", [phone, adminId]);
        }
        ...
        if (first_name !== undefined || middle_name !== undefined || last_name !== undefined) {
            ...
            const [profileExists] = await query("SELECT id FROM user_profiles WHERE user_id = ?", [adminId]);
            if (profileExists) {
                ...
                if (profileUpdates.length > 0) {
                    ...
                    await query(`UPDATE user_profiles SET ${profileUpdates.join(', ')}, updated_at = CURRENT_TIMESTAMP WHERE user_id = ?`, profileValues);
                }
            }
            else {
                // Create new profile
                await query("INSERT INTO user_profiles (user_id, first_name, middle_name, last_name, gender_id, date_of_birth) VALUES (?, ?, ?, ?, 1, '1990-01-01')", [adminId, first_name || '', middle_name || null, last_name || '']);
            }
        }
        // Get updated admin data
        const [updatedAdmin] = await query(`SELECT u.id, u.email, u.phone,
              COALESCE(up.first_name, '') as first_name,
              COALESCE(up.middle_name, '') as middle_name,
              COALESCE(up.last_name, '') as last_name,
              TRIM(CONCAT(
...
async function changeAdminPassword(req, res) {
    try {
        ...
        const [admin] = await query("SELECT id, password FROM users WHERE id = ? AND user_type_id = 2", [adminId]);
        if (!admin) {
            return res.status(404).json({
                success: false,
                message: "Admin not found",
        ...
        // Update password
        await query("UPDATE users SET password = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?", [hashedNewPassword, adminId]);
        res.json({
            success: true,
...
async function getAllPaymentsHistory(req, res) {
    try {
...
async function getUserPaymentsHistory(req, res) {
    try {
        const { id: userId } = req.params;
    ...
    `, [userId, parseInt(limit), offset]);
        const [{ total }] = await query("SELECT COUNT(*) as total FROM payments WHERE user_id = ?", [userId]);
        res.json({
            success: true,
            data: payments,
            pagination: {
...
async function updatePaymentStatus(req, res) {
    try {
        ...
        const [statusRecord] = await query("SELECT id FROM payment_status_master WHERE status_name = ?", [mappedStatus]);
        if (!statusRecord) {
            return res.status(400).json({
                success: false,
        ...
        await query("UPDATE payments SET payment_status_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?", [statusRecord.id, id]);
        // Find related subscription if exists
        const [subscription] = await query("SELECT id FROM user_subscriptions WHERE user_id = ? AND plan_id = ? ORDER BY created_at DESC LIMIT 1", [existing.user_id, existing.plan_id]);
        // If payment is marked as successful, activate the subscription
        if (mappedStatus === 'paid' && subscription) {
            await query("UPDATE user_subscriptions SET subscription_status_id = 1, is_active = TRUE WHERE id = ?", [subscription.id]);
        }
        ...
        if (['failed', 'refunded'].includes(mappedStatus) && subscription) {
            await query("UPDATE user_subscriptions SET subscription_status_id = 3, is_active = FALSE WHERE id = ?", [subscription.id]);
        }
        res.json({
            success: true,
...
async function createSiteSetting(req, res) {
    ...
    try {
        ...
        const created_by = (_a = req.admin) === null || _a === void 0 ? void 0 : _a.user_id;
        ...
        const [existing] = await query('SELECT id FROM site_settings WHERE page_name = ? AND deleted_at IS NULL', [page_name]);
        if (existing) {
            return res.status(400).json({
                success: false,
        ...
        const result = await query(`INSERT INTO site_settings
      (page_name, title, sub_title, meta_title, meta_description, keywords, status, created_by)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [page_name, title, sub_title || null, meta_title || null, meta_description || null, keywords || null, status || 'active', created_by]);
        res.status(201).json({
            success: true,
...
async function getAllSiteSettings(req, res) {
    try {
        const page = parseInt(req.query.page) || 1;
        const limit = parseInt(req.query.limit) || 10;
        const offset = (page - 1) * limit;
        ...
        // Get total count
        const [countResult] = await query(`SELECT COUNT(*) as total FROM site_settings ${whereClause}`, queryParams);
        const total = countResult.total;
        // Get paginated results
        const rows = await query(`SELECT id, page_name, title, sub_title, meta_title, meta_description, keywords, status, created_by, created_at, updated_at
...
async function getSiteSettingById(req, res) {
    try {
        ...
        const [siteSettings] = await query(`SELECT id, page_name, title, sub_title, meta_title, meta_description, keywords, status, created_by, created_at, updated_at
      FROM site_settings
...
async function getSiteSettingByName(req, res) {
    try {
        ...
        const [siteSettings] = await query(`SELECT id, page_name, title, sub_title, meta_title, meta_description, keywords, status, created_by, created_at, updated_at
      FROM site_settings
      WHERE page_name = ? AND deleted_at IS NULL AND status = 'active'`, [name]);
        if (!siteSettings) {
            return res.status(404).json({
                success: false,
                message: 'Site setting not found'
...
async function updateSiteSetting(req, res) {
    try {
        ...
        // Check if record exists
        const [existing] = await query('SELECT id FROM site_settings WHERE id = ? AND deleted_at IS NULL', [id]);
        if (!existing) {
            return res.status(404).json({
                success: false,
                message: 'Site setting not found'
        ...
        if (page_name) {
            const [duplicateCheck] = await query('SELECT id FROM site_settings WHERE page_name = ? AND id != ? AND deleted_at IS NULL', [page_name, id]);
            if (duplicateCheck) {
                return res.status(400).json({
                    success: false,
                    message: 'Site setting with this page name already exists'
        ...
        updateValues.push(id);
        await query(`UPDATE site_settings SET ${updateFields.join(', ')} WHERE id = ?`, updateValues);
        // Get updated record
        const [updatedRecord] = await query(`SELECT id, page_name, title, sub_title, meta_title, meta_description, keywords, status, created_by, created_at, updated_at
      FROM site_settings
      WHERE id = ?`, [id]);
        res.status(200).json({
            success: true,
...
async function deleteSiteSetting(req, res) {
    try {
        ...
        await query('UPDATE site_settings SET deleted_at = NOW() WHERE id = ?', [id]);
        res.status(200).json({
            success: true,
...
async function createCurrencySetting(req, res) {
    var _a;
    try {
        ...
        const result = await query(`INSERT INTO currency_settings
      (home_currency_id, system_currency_id, currency_format_id, symbol_format_id, no_of_decimals_id, status, created_by)
      VALUES (?, ?, ?, ?, ?, ?, ?)`, [home_currency_id, system_currency_id, currency_format_id, symbol_format_id, no_of_decimals_id, status || 'active', created_by]);
        res.status(201).json({
            success: true,
...
async function getAllCurrencySettings(req, res) {
    try {
        const page = parseInt(req.query.page) || 1;
        const limit = parseInt(req.query.limit) || 10;
        const offset = (page - 1) * limit;
        ...
        // Get total count
        const [countResult] = await query(`SELECT COUNT(*) as total FROM currency_settings cs ${whereClause}`, queryParams);
        const total = countResult.total;
        // Get paginated results with all related data
        const rows = await query(`SELECT cs.id, cs.home_currency_id, cs.system_currency_id, cs.currency_format_id,
...
async function getCurrencySettingById(req, res) {
    try {
        const { id } = req.params;
        if (!id || isNaN(Number(id))) {
            return res.status(400).json({
        ...
        const [currencySetting] = await query(`SELECT cs.id, cs.home_currency_id, cs.system_currency_id, cs.currency_format_id,
              cs.symbol_format_id, cs.no_of_decimals_id, cs.status, cs.created_by,
              cs.created_at, cs.updated_at,
              hc.currency_name as home_currency_name, hc.currency_code as home_currency_code, hc.symbol as home_currency_symbol,
              sc.currency_name as system_currency_name, sc.currency_code as system_currency_code, sc.symbol as system_currency_symbol,
       ...
       LEFT JOIN symbol_format sf ON cs.symbol_format_id = sf.id
       LEFT JOIN no_of_decimals nod ON cs.no_of_decimals_id = nod.id
       WHERE cs.id = ? AND cs.deleted_at IS NULL`, [id]);
        if (!currencySetting) {
            return res.status(404).json({
                success: false,
...
async function updateCurrencySetting(req, res) {
    try {
        const { id } = req.params;
        const { home_currency_id, system_currency_id, currency_format_id, symbol_format_id, no_of_decimals_id, status } = req.body;
        if (!id || isNaN(Number(id))) {
        ...
        // Check if record exists
        const [existing] = await query('SELECT id FROM currency_settings WHERE id = ? AND deleted_at IS NULL', [id]);
        if (!existing) {
            return res.status(404).json({
                success: false,
                message: 'Currency setting not found'
        ...
        updateValues.push(id);
        await query(`UPDATE currency_settings SET ${updateFields.join(', ')} WHERE id = ?`, updateValues);
        // Get updated record
        const [updatedRecord] = await query(`SELECT cs.id, cs.home_currency_id, cs.system_currency_id, cs.currency_format_id,
              cs.symbol_format_id, cs.no_of_decimals_id, cs.status, cs.created_by,
              cs.created_at, cs.updated_at,
              hc.currency_name as home_currency_name, hc.currency_code as home_currency_code, hc.symbol as home_currency_symbol,
              sc.currency_name as system_currency_name, sc.currency_code as system_currency_code, sc.symbol as system_currency_symbol,
...
async function deleteCurrencySetting(req, res) {
    try {
        const { id } = req.params;
        if (!id || isNaN(Number(id))) {
            return res.status(400).json({
        ...
        // Soft delete the record
        await query('UPDATE currency_settings SET deleted_at = NOW() WHERE id = ?', [id]);
        res.status(200).json({
            success: true,
...
async function getCurrencyFormats(req, res) {
    try {
        const formats = await query('SELECT id, format_name, format_pattern, description, example FROM currency_format WHERE status = "active" ORDER BY id');
        res.status(200).json({
            success: true,
            data: formats
        });
...
// Get Symbol Formats
async function getSymbolFormats(req, res) {
    try {
        const formats = await query('SELECT id, format_name, format_pattern, description, example FROM symbol_format WHERE status = "active" ORDER BY id');
        res.status(200).json({
            success: true,
            data: formats
        });
...
// Get No Of Decimals
async function getNoOfDecimals(req, res) {
    try {
        const decimals = await query('SELECT id, decimal_name, decimal_places, description, example FROM no_of_decimals WHERE status = "active" ORDER BY decimal_places');
        res.status(200).json({
            success: true,
            data: decimals
        });
...
async function createCurrencyFormat(req, res) {
    try {
        ...
        const [existing] = await query('SELECT id FROM currency_format WHERE format_name = ?', [format_name]);
        if (existing) {
            return res.status(400).json({
                success: false,
        ...
        const result = await query(`INSERT INTO currency_format (format_name, format_pattern, description, example, status)
       VALUES (?, ?, ?, ?, ?)`, [format_name, format_pattern, description || null, example || null, status || 'active']);
        res.status(201).json({
            success: true,
...
async function updateCurrencyFormat(req, res) {
    try {
        const { id } = req.params;
        const { format_name, format_pattern, description, example, status } = req.body;
        if (!id || isNaN(Number(id))) {
        ...
        // Check if record exists
        const [existing] = await query('SELECT id FROM currency_format WHERE id = ?', [id]);
        if (!existing) {
            return res.status(404).json({
                success: false,
        ...
        if (format_name) {
            const [duplicateCheck] = await query('SELECT id FROM currency_format WHERE format_name = ? AND id != ?', [format_name, id]);
            if (duplicateCheck) {
                return res.status(400).json({
                    success: false,
                    message: 'Currency format with this name already exists'
        ...
        updateValues.push(id);
        await query(`UPDATE currency_format SET ${updateFields.join(', ')} WHERE id = ?`, updateValues);
        // Get updated record
        const [updatedRecord] = await query('SELECT id, format_name, format_pattern, description, example, status, created_at, updated_at FROM currency_format WHERE id = ?', [id]);
        res.status(200).json({
            success: true,
...
async function deleteCurrencyFormat(req, res) {
    try {
        const { id } = req.params;
        if (!id || isNaN(Number(id))) {
            return res.status(400).json({
        ...
        const [inUse] = await query('SELECT id FROM currency_settings WHERE currency_format_id = ? AND deleted_at IS NULL', [id]);
        if (inUse) {
            return res.status(400).json({
                success: false,
...
async function createSymbolFormat(req, res) {
    try {
        const { format_name, format_pattern, description, example, status } = req.body;
        if (!format_name || !format_pattern) {
            return res.status(400).json({
        ...
        // Check if format_name already exists
        const [existing] = await query('SELECT id FROM symbol_format WHERE format_name = ?', [format_name]);
        if (existing) {
            return res.status(400).json({
                success: false,
        ...
        const result = await query(`INSERT INTO symbol_format (format_name, format_pattern, description, example, status)
       VALUES (?, ?, ?, ?, ?)`, [format_name, format_pattern, description || null, example || null, status || 'active']);
        res.status(201).json({
            success: true,
...
async function updateSymbolFormat(req, res) {
    try {
        const { id } = req.params;
        const { format_name, format_pattern, description, example, status } = req.body;
        if (!id || isNaN(Number(id))) {
        ...
        // Check if record exists
        const [existing] = await query('SELECT id FROM symbol_format WHERE id = ?', [id]);
        if (!existing) {
            return res.status(404).json({
                success: false,
        ...
        // Check if format_name already exists for other records
        if (format_name) {
            const [duplicateCheck] = await query('SELECT id FROM symbol_format WHERE format_name = ? AND id != ?', [format_name, id]);
            if (duplicateCheck) {
                return res.status(400).json({
                    success: false,
                    message: 'Symbol format with this name already exists'
        ...
        updateValues.push(id);
        await query(`UPDATE symbol_format SET ${updateFields.join(', ')} WHERE id = ?`, updateValues);
        // Get updated record
        const [updatedRecord] = await query('SELECT id, format_name, format_pattern, description, example, status, created_at, updated_at FROM symbol_format WHERE id = ?', [id]);
        res.status(200).json({
            success: true,
...
async function deleteSymbolFormat(req, res) {
    try {
        const { id } = req.params;
        if (!id || isNaN(Number(id))) {
            return res.status(400).json({
        ...
        // Check if format is being used in currency_settings
        const [inUse] = await query('SELECT id FROM currency_settings WHERE symbol_format_id = ? AND deleted_at IS NULL', [id]);
        if (inUse) {
            return res.status(400).json({
                success: false,
...
async function createNoOfDecimals(req, res) {
    try {
        ...
        const [existing] = await query('SELECT id FROM no_of_decimals WHERE decimal_name = ?', [decimal_name]);
        if (existing) {
            return res.status(400).json({
                success: false,
        ...
        const result = await query(`INSERT INTO no_of_decimals (decimal_name, decimal_places, description, example, status)
       VALUES (?, ?, ?, ?, ?)`, [decimal_name, Number(decimal_places), description || null, example || null, status || 'active']);
        res.status(201).json({
            success: true,
...
async function updateNoOfDecimals(req, res) {
    try {
        const { id } = req.params;
        const { decimal_name, decimal_places, description, example, status } = req.body;
        if (!id || isNaN(Number(id))) {
        ...
        // Check if record exists
        const [existing] = await query('SELECT id FROM no_of_decimals WHERE id = ?', [id]);
        if (!existing) {
            return res.status(404).json({
                success: false,
        ...
        if (decimal_name) {
            const [duplicateCheck] = await query('SELECT id FROM no_of_decimals WHERE decimal_name = ? AND id != ?', [decimal_name, id]);
            if (duplicateCheck) {
                return res.status(400).json({
                    success: false,
                    message: 'Decimal format with this name already exists'
        ...
        updateValues.push(id);
        await query(`UPDATE no_of_decimals SET ${updateFields.join(', ')} WHERE id = ?`, updateValues);
        // Get updated record
        const [updatedRecord] = await query('SELECT id, decimal_name, decimal_places, description, example, status, created_at, updated_at FROM no_of_decimals WHERE id = ?', [id]);
        res.status(200).json({
            success: true,
...
async function deleteNoOfDecimals(req, res) {
    try {
        const { id } = req.params;
        if (!id || isNaN(Number(id))) {
            return res.status(400).json({
        ...
        // Check if format is being used in currency_settings
        const [inUse] = await query('SELECT id FROM currency_settings WHERE no_of_decimals_id = ? AND deleted_at IS NULL', [id]);
        if (inUse) {
            return res.status(400).json({
                success: false,
...
async function getAdminDashboard(req, res) {
    ...
    `);
      ...
      LEFT JOIN currency_master cm ON p.currency_id = cm.id
      LEFT JOIN subscription_plans sp ON p.plan_id = sp.id
      WHERE (p.payment_status_id = 1 OR LOWER(psm.status_name) IN ('paid', 'captured', 'success', 'successful'))
      ORDER BY p.payment_date DESC, p.created_at DESC
      LIMIT 5
    `);
        ...
        res.json({
            ...
            data: {
                ...
                statistics: {
                    ...
                    active_members_count: stats.active_members_count || 0,
